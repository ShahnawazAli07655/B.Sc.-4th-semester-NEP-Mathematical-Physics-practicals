...
(i) \( \frac{dy}{dx} = e^x \) with \( y = 0 \) for \( x = 0 \)  
(ii) \( \frac{dy}{dx} + e^{-x}y = x^2 \)  
(iii) \( \frac{d^2y}{dx^2} + 2\frac{dy}{dx} = -y \)  
(iv) \( \frac{d^2y}{dx^2} + e^{-x}\frac{dy}{dx} = -y \)
...
### Aim  
To perform the multiplication of two \( 3 \times 3 \) matrices.
...
### Aim  
To compute the eigenvalues and eigenvectors of the given matrices.
...
### Aim  
To compute the n-th roots of unity for \( n = 2, 3 \) and \( 4 \).
...
### Aim  
To find the two square roots of the complex number \( 5 + 12i \).
